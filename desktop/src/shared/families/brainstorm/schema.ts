...
/** Spec §3.6. BrainstormNote overlay on PurposeDrivenNote. ideas[].id is post-decode (LLM never emits; assignBrainstormIdeaIds fills uuid v4). No decisions field by design (divergent). */
