...
| 0.2 3B Lecture | Zod validates + ≥1 slot emergence + < 30s per chunk | **MIXED** (2026-05-27: 3/3 Zod-valid · 3/3 ≥1 slot (counts 4/2/4, all formula) · latency p50 = 90 s, p90 = 99 s — 3× over 30 s budget on M3/8GB · 11.3K transcript chars / 13.4K prompt chars / 8 K JA tokens, at top of §2.3 ~8K chunk budget) | Structural + quality dimensions PASS, latency dimension FAIL. Memo: `02-3b-lecture-grammar/decision-0.2-latency.md` — recommends Path E (per-phase timing capture) before choosing A/B/C/D from spec §7.2 ladder. |
