...
const HAPPY_Y = 0
// Branch axis below the happy path. Vertical gap is matched to the
// horizontal arrow length (≈100 px) for visual consistency: with a
// 700 px tall scene/header, BRANCH_Y=800 leaves ~100 px of canvas
// between the two stacked nodes.
const BRANCH_Y = 800
